    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(upload_to='tasks-photos/', validators=[tasks.models.validate_photo_file_extension], verbose_name='Photo')),
                ('reward', models.IntegerField(default=0, verbose_name='Reward')),
                ('validation_reward', models.IntegerField(default=0, verbose_name='Validation Reward')),
                ('description', models.TextField(verbose_name='Description')),
                ('text', models.TextField(verbose_name='Text')),
                ('audio_text', models.TextField(blank=True, default=None, null=True, verbose_name='Audio Text')),
                ('example', models.FileField(blank=True, default=None, null=True, upload_to='file-examples/', validators=[tasks.models.validate_example_file_extension], verbose_name='Example File')),
                ...
                ('validation_limit', models.IntegerField(default=2, verbose_name='Validation Limit for one completion')),
